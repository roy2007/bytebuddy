...
public class ReflectionUtil {
  ...
  public static void copy(final Object to, final Object from, final boolean primeOnly) {
    ...
    try {
      iterateFields(to, new FieldFoundCallback() {
        public void field(Object o, Field field) throws Exception {
          ...
          Method setter = getSetter(to.getClass(), field.getName(), fieldType);
          ...
          if (isPrimeType(fieldType)) {
            ...
            Object toFieldValue = copy(fieldType, fromFieldValue, primeOnly);
  ...
  public static void iterateClassTree(Class<?> clazz, ClassCallback callback) throws Exception {
    while (true) {
  ...
  public static void iterateFields(final Object o, final FieldFoundCallback callback) throws Exception {
    iterateFields(o.getClass(), o, callback);
  }

  public static void iterateFields(final Class<?> clazz, final Object o, final FieldFoundCallback callback)
      throws Exception {
  ...
  public static void iterateMethods(final Object o, final MethodFoundCallback callback) throws Exception {
  ...
  public static void iterateAnnotatedFields(final Object o, final Class<?> annoClass,
      final AnnotatedFieldCallback callback) throws Exception {
    iterateAnnotatedFields(o.getClass(), o, annoClass, callback);
  }

  public static void iterateAnnotatedMethods(final Object o, final Class<?> annoClass,
      final AnnotatedMethodCallback callback) throws Exception {
    iterateAnnotatedMethods(o.getClass(), o, annoClass, callback);
  }

  public static void iterateAnnotatedFields(final Object o, final Class<?> annoClass, final Class<?> fieldType,
      final AnnotatedFieldCallback callback) throws Exception {
    iterateAnnotatedFields(o.getClass(), o, annoClass, fieldType, callback);
  }

  public static void iterateAnnotatedFields(final Class<?> clazz, final Object o, final Class<?> annoClass,
      final AnnotatedFieldCallback callback) throws Exception {
    iterateClassTree(clazz, new ClassCallback() {
      public void classFound(Class<?> cls) throws Exception {
        for (Field field : cls.getDeclaredFields()) {
  ...
  private static void iterateAnnotatedFields(final Class<?> clazz, final Object o, final Class<?> annoClass,
      final Class<?> fieldType, final AnnotatedFieldCallback callback) throws Exception {
    iterateClassTree(clazz, new ClassCallback() {
      public void classFound(Class<?> cls) throws Exception {
        for (Field field : cls.getDeclaredFields()) {
  ...
  private static void iterateAnnotatedMethods(final Class<?> clazz, final Object o, final Class<?> annoClass,
      final AnnotatedMethodCallback callback) throws Exception {
    iterateClassTree(clazz, new ClassCallback() {
      @Override
      public void classFound(Class<?> cls) throws Exception {
        for (Method method : cls.getDeclaredMethods()) {
          for (Annotation methodAnnot : method.getAnnotations()) {
            if (methodAnnot.annotationType().equals(annoClass)) {// annoClass = org.foo.Foos(url="insert")
              // 获取该方法的MyAnnotation注解实例
              Foos myAnnotation = method.getAnnotation(Foos.class);
              // 获取myAnnotation
              String value1 = myAnnotation.url();
              System.out.println("value=" + value1);
              if (value1.trim().equals("insert")) {
                callback.method(o, method);
                break;
              }
            }
  ...
  public static AnnotatedField<?> getAnnotatedField(final Object o, final Class<?> annoClass) throws Exception {
    return getAnnotatedField(o, annoClass, Object.class);
  }

  public static <T> AnnotatedField<T> getAnnotatedField(final Object o, final Class<?> annoClass, Class<T> clazz)
      throws Exception {
    AnnotatedField<T> raf = new AnnotatedField<T>();
    iterateAnnotatedFields(o, annoClass, raf);
    return raf;
  }

  public static Field getAnnotatedField(final Class<?> annoClass, Class<?> clazz) throws Exception {
    final ArrayList<Field> holder = new ArrayList<Field>();
    iterateAnnotatedFields(clazz, (Object) null, annoClass, new AnnotatedFieldCallback() {
      @Override
      public void field(Object o, Field field) throws Exception {
        field.setAccessible(true);
        holder.add(field);
  ...
  public static void setAnnotatedFields(final Object o, final Class<?> annoClass, final Class<?> fieldType,
  ...
  public static boolean annotatedWith(Field field, Class annoCls) {
    for (Annotation an : field.getAnnotations()) {
      if (an.annotationType().equals(annoCls))
        return true;
    }
    return false;
  }
  ...
  public static void callSetter(Object target, String fieldName, Object fieldValue, Class<?> fieldType)
      throws Exception {
